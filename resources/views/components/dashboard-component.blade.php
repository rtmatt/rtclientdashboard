@if(!empty($dashboard_data))
    ...
    <div class="RT-Client_Dashboard" id="js--Client-Dashboard{!!isset($dashboard_id)?'_'.$dashboard_id:''!!}">
            ...
            <div class="StatusBarContent clearfix">
                ...
                <div class="UsageContent">
                    <div class="UsageContent__row clearfix">
                        <div class="UsageContent__label UsageContent__label--monthly u--float-left-tablet-portrait-min">
                            <div class="DashboardIconLabel clearfix">
                                <img src='/vendor/rtclientdashboard/images/icon-clock.png'
                                     class="DashboardIconLabel__icon" alt="Monthly Hours">
                            ...
                            <div class="MonthWrap clearfix">
                                @foreach($dashboard_data->monthly as $key=>$month)
                                    <div class="month{!!$month->is_current_month?' current-month':''!!}"
                                        ...
                                        <div class="js--graph Month-Graph-Wrap"
                                             id="js--circle-{{$key}}{!!isset($dashboard_id)?'--dashboard-'.$dashboard_id:''!!}"></div>
                                    </div>
                                @endforeach
                            </div>
                            <!-- END OF: 'MonthWrap' -->
                    ...
                    <div class="UsageContent__row clearfix">
                        <div class="UsageContent__label UsageContent__label--yearly u--float-left-tablet-portrait-min">
                            <div class="DashboardIconLabel clearfix">
                                <img src='/vendor/rtclientdashboard/images/icon-calendar.png'
                                     class="DashboardIconLabel__icon" alt="Yearly Balance">
                ...
                <div class="StatusBarSecondaryContent clearfix">
                    ...
                    <div class="StatusBarSecondaryInformation u--float-left-tablet-portrait-min clearfix">
                        ...
                        @if(isset($admin_mode))
                            <a class="StatusBarSecondaryInformation__item clearfix StatusBarSecondaryInformation__item--services"
                               ng-click="clientDashboardController.logBackup()">
                                <div class="DashboardIconLabel DashboardIconLabel--secondary-content clearfix">
                                    <img class="DashboardIconLabel__icon u--remove-float-desktop u--margin-auto-desktop"
                                         src="/images/icon-clock.svg" alt="Log Backup">
                        ...
                        @else
                            <a class="StatusBarSecondaryInformation__item clearfix StatusBarSecondaryInformation__item--services js--Modal-Trigger"
                               href="#" data-toggle="modal" data-target="#myModal">
                                <div class="DashboardIconLabel DashboardIconLabel--secondary-content clearfix">
                                    <img class="DashboardIconLabel__icon u--remove-float-desktop u--margin-auto-desktop"
                                         src='/vendor/rtclientdashboard/images/icon-document.png'
                    ...
                    <a class="StatusBarAlertButton u--float-left-tablet-portrait-min js--Dashboard__alert-toggle"
                       href="#">
                        <div class="DashboardIconLabel DashboardIconLabel--secondary-content u--full-center-desktop clearfix">
                            <img class="DashboardIconLabel__icon DashboardIconLabel__icon--priority js--PriorityAlert-Toggle__icon"
                                 src='/vendor/rtclientdashboard/images/icon-alert.png'
                                 data-alt-src="/vendor/rtclientdashboard/images/icon-x.png" alt="Priority Alert">
                            <span class="DashboardIconLabel__text DashboardIconLabel__text--priority js--PriorityAlert-Toggle__text"
                                  data-toggle-template="Close">Priority Alert</span>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <section
                class="RT-Dashboard-Form {!!!isset($admin_mode)?'RT-Dashboard-Form--priority':'RT-Dashboard-Form--admin'!!} clearfix js--Dashboard__alert-form">
            @if(isset($admin_mode))
                @include('rtclientmanager::partials.edit-form')
            @else
                <form class="js--Dashboard-Alert-Form" enctype="multipart/form-data">
                    <div class="RT-Dashboard-Form__column RT-Dashboard-Form__column--alert">
                        <div class="AlertFormIssueCol__description u--bottom-margin-50-mobile-min">
                            <div class="AlertFormIssueCol__description-col">
                                <div class="AlertFormIssueCol__description-col-wrapper AlertFormIssueCol__description-col-wrapper--padding-right">
                                    <label class="RT-Dashboard-Form__label RT-Dashboard-Form__label--large"
                                           for="actualHappening">What's happening is
                                    </label>
                            ...
                            <div class="AlertFormIssueCol__description-col clearfix">
                                <div class="AlertFormIssueCol__description-col-wrapper AlertFormIssueCol__description-col-wrapper--padding-left">
                                    <label class="RT-Dashboard-Form__label RT-Dashboard-Form__label--large"
                                           for="expectedToHappen">What should happen is
                                    </label>
                        ...
                        <div class="AlertFormIssueCol__frequency u--bottom-margin-50-mobile-min clearfix">
                            <span class="RT-Dashboard-Form__label RT-Dashboard-Form__label--large">This happens</span>
                            <div class="AlertFormIssueCol__frequency-options">
                                <div class="AlertFormIssueCol__frequency-options-wrapper">
                                    ...
                                    <label class="AlertFormIssueCol__frequency-options-label" for="frequencyEveryTime">
                                        Every
                                        time
                                    </label>
                                </div>
                                <div class="AlertFormIssueCol__frequency-options-wrapper">
                                    ...
                                    <label class="AlertFormIssueCol__frequency-options-label" for="frequencyOften">Often
                                    </label>
                                </div>
                                <div class="AlertFormIssueCol__frequency-options-wrapper">
                                    <input class="AlertFormIssueCol__frequency-options-option" type="radio"
                                           id="frequencyOccasionally" name="frequency" value="occasionally">
                                    <label class="AlertFormIssueCol__frequency-options-label"
                                           for="frequencyOccasionally">
                                        Occasionally
                                    </label>
                                </div>
                                <div class="AlertFormIssueCol__frequency-options-wrapper">
                                    ...
                                    <label class="AlertFormIssueCol__frequency-options-label" for="frequencyOnlyOnce">
                                        Only
                                        once
                                    </label>
                                </div>
                        ...
                        <div class="AlertFormIssueCol__specs u--bottom-margin-50-mobile-min clearfix">
                            <span class="RT-Dashboard-Form__label RT-Dashboard-Form__label--large">When using</span>
                            <div class="AlertFormIssueCol__specs-options">
                                <div class="AlertFormIssueCol__specs-options-wrapper">
                                    <input class="AlertFormIssueCol__specs-input" type="text" id="userDevice"
                                           name="user_device"
                                           placeholder="Device (ie. iPhone, PC)">
                                </div>
                                <div class="AlertFormIssueCol__specs-options-wrapper">
                                    <input class="AlertFormIssueCol__specs-input" type="text" id="userOS"
                                           name="user_browser"
                        ...
                        <span class="RT-Dashboard-Form__label RT-Dashboard-Form__label--large">Attach Screenshot <span
                                    class="u--light-text">(Optional)</span></span>
                            <input class="AlertFormIssueCol__screenshot-input" type="file" id="fileAttach"
                                   name="attachment">
                        </div>
                    </div>
                    <div class="RT-Dashboard-Form__column RT-Dashboard-Form__column--contact">
                        <div class="AlertFormContactCol__user-info u--bottom-margin-50-mobile-min clearfix">
                            <span class="RT-Dashboard-Form__label RT-Dashboard-Form__label--large u--bottom-margin-25-mobile-min">Who should we contact about this?</span>
                ...
                <textarea class="AlertFormContactCol__additional-info-textarea" id="anything-else"
                        ...
                        <input type="submit" data-toggle-text="Sending..."
                               class="RT-Dashboard-Form__button RT-Dashboard-Form__button--priority-submit  js--Alert-Submit-Button"
                               value="Send Alert">
                    </div>
                </form>
            @endif
